...
using CustomCollectionsTests;
using Entities;
using Tree = CustomCollections.BinaryTree<int>;
using TreeS = CustomCollections.BinaryTree<string>;
using TreeB = CustomCollections.BinaryTree<Entities.Book>;
using TreeP = CustomCollections.BinaryTree<CustomCollectionsTests.Point>;
